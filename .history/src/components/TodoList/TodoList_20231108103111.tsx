  ...
  return (
    <div className={styles.todoList}>
      <div className={styles.todoListContainer}>
        ...
        <TaskList doneTaskList={false} todos={notDoneTasks} handleEditDoneTodos={handleEditDoneTodos} />
        <TaskList doneTaskList={true} todos={doneTasks} handleEditDoneTodos={handleEditDoneTodos} />
      </div>
    </div>
  )
}
